...
Singleton {
    ...
    readonly property string temp: Config.services.temperatureUnit === "fahrenheit" ? `${cc?.tempF ?? 0}°F` : `${cc?.tempC ?? 0}°C`
    readonly property string feelsLike: Config.services.temperatureUnit === "fahrenheit" ? `${cc?.feelsLikeF ?? 0}°F` : `${cc?.feelsLikeC ?? 0}°C`
